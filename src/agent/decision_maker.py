...
class TradingAgent:
    ...
    async def _decide(self, context, assets, model=None, macro_context=None):
        ...
        system_prompt = (
            ...
            "    - intraday.rvol ≥ 1.2 on the signal bar\n"
            ...
            "    TP1 partial exit (50% at bias_1h.tp1_long/tp1_short): encode in exit_plan.\n"
            "    After TP1 fills: sell/buy close_fraction=0.5, then update_tpsl to move SL to entry (breakeven).\n\n"
